...
class SimpleCaptcha {
    ...
    public $colors = array(85, 85, 85);  // grey

    /** Shadow color in RGB-array or null */
    // public $shadowColor = null; //array(0, 0, 0);
	public $shadowColor = array(245, 245, 245);  // grey
     ...
     */
    public $fonts = array(
        'Wellfleet' => array('spacing' => 0, 'minSize' => 18, 'maxSize' => 24, 'font' => 'wellfleet.ttf'),
    );

    /** Wave configuracion in X and Y axes */
    public $Yperiod    = 10; // 12;
    public $Yamplitude = 10; // 14;
    public $Xperiod    = 10; // 11;
    public $Xamplitude = 10; // 5;

    /** letter rotation clockwise */
    public $maxRotation = 10; // 8;
    ...
    protected function GetRandomCaptchaText($length = null) {
        ...
        for ($i=0; $i<$length; $i++) {/*
            ...
            $vocal = !$vocal;*/
			$text .= substr($words, mt_rand(0, 23), 1);
        }
        return $text;
    }
    ...
    protected function WaveImage() {
        ...
        $k = rand(0, 100);
        $yp = $this->scale * $this->Yperiod * rand(1, 3); // 1, 2
